...
class SeasonsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post seasons_url, params: { season: { year: 2019 } } # 2018 is already taken by fixtures
    end
  ...
  test "should update season" do
    patch season_url(@season), params: { season: { establishment_id: @season.establishment_id, year: @season.year } }
